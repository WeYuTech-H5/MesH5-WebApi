...
{
    public class MasterMainGridColController : ApiController
    {
        ...
        [ModelName("MasterMainGrid_Query_Data")]
        ...
        public HttpResponseMessage Post([FromBody] Query_Data oDATA)
        {
            ...
            try
            {
                ...
                log = LogManager.GetLogger(typeof(MasterMainGridColController));
                ...
                if (session["Key"] != null)
                {
                    ...
                    //string sql = $"SELECT * FROM BAS_MASTER_MAINTAIN_GRID_COLUMNS WHERE MM_SID= {SID} ORDER BY COL_ID ASC";
                    string sql = $"SELECT * FROM BAS_MASTER_MAINTAIN_GRID_COLUMNS WHERE MM_SID= {SID} ORDER BY SEQ ASC";

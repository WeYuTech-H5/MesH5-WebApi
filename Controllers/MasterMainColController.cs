...
{
    public class MasterMainColController : ApiController
    {
        ...
        [ModelName("MasterMainCol_Query_Data")]
        ...
        public HttpResponseMessage Post([FromBody] Query_Data oDATA)
        {
            try
            {
                ...
                log = LogManager.GetLogger(typeof(MasterMainColController));
                ...
                if (session["Key"] != null)
                {
                    ...
                    string sql = $"SELECT * FROM BAS_MASTER_MAINTAIN_COLUMNS WHERE MM_SID = {SID} ORDER BY COL_ID ASC";

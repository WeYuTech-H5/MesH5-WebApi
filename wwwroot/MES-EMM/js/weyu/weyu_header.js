...
// 修改密碼
// let changePWD = document.getElementById('changePassword')
// let changePWDString =
// `<button class="text-sky-200 ml-auto Lang" style="padding: 10px">Change Password</button>`
// changePWD.innerHTML = changePWDString
// document.addEventListener("DOMContentLoaded", () => {
//   document.querySelector('#changePassword button').addEventListener("click", function() {
//     openChangePwdModal()
//   })
// })
...
let doughnut2SID = "361124905113294";
//右上長餅條圖SID
...
let BarChartDSID = "361288730930910";
...
async function fetchData() {
    ...
    let doughnut2Data = await getChartData(doughnut2SID);
...
function DoughnutChart(Data) {
    ...
    let doughnutCanvas = document.getElementById('DoughnutChart1');
    // 甜甜圈圖
...
function DoughnutChart2(Data) {
    ...
    let fillBgColor = ['#FF0000', '#FFFF00', '#00FF00'];
    let doughnutCanvas = document.getElementById('DoughnutChart2');
    // 甜甜圈圖
    new Chart(doughnutCanvas, {
        type: "doughnut",
        data: {
    ...
    document.getElementById("OEE2").innerText = `${percentage.toFixed(0)}%`;
}
//Y軸長餅圖 右上
